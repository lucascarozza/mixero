...
1. **Unavailable Track Previews**: Some track preview samples may not be available due to Spotify's limitations. This won't be fixed.
2. **Multiple Audio Playback**: Playing a new audio sample will not automatically pause the previous one. No workaround available.
3. **Mobile Browser Login Redirect**: Exclusively on mobile browsers, the Spotify login redirect may not function properly. To workaround this issue:
...
## Screenshots
![Mixero Web Preview](./public/web_preview.jpeg)
